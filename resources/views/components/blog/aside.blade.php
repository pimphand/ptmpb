<aside class="side-bar">
    ...
    <div class="widget bg-white ">
        <h4 class="widget-title">Cari Blog</h4>
        <div class="search-bx">
            ...
            <div class="wt-tabs tabs-default border">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" data-bs-toggle="tab" href="#web-design-1" aria-selected="true"
                            role="tab">Berita Lama</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" data-bs-toggle="tab" href="#graphic-design-1" aria-selected="false"
                            tabindex="-1" role="tab">Popular</a>
                    </li>
                </ul>
                            ...
                            @foreach ($old as $ol)
                                <div class="widget-post clearfix bg-gray">
                                    <div class="wt-post-media">
                                        <img src="{{ asset('storage/' . $ol->thumbnail) }}" alt="{{ $ol->title }}"
                                            class="radius-bx">
                                    </div>
                                    <div class="wt-post-info">
                                        ...
                                        <div class="wt-post-meta">
                                            <ul>
                                                <li class="post-author">{{ date('d M', strtotime($ol->created_at)) }}
                                                </li>
                    ...
                    <div id="graphic-design-1" class="tab-pane" role="tabpanel">
                        <div class="widget-post-bx">
                            ...
                            @foreach ($populers as $populer)
                                <div class="widget-post clearfix bg-gray">
                                    <div class="wt-post-media">
                                        <img src="{{ asset('storage/' . $populer->thumbnail) }}" alt=""
                                            class="radius-bx">
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-header">
