                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                <div class="flex-shrink-0">
                                    <img src="{{ $customer->photo ? $customer->photo : asset('admin/assets/images/user-42.jpg') }}"
                                        class="rounded-circle border border-2 wh-75" alt="user">
                                </div>
                                <div class="flex-grow-1 ms-3">
                                    <h4 class="fs-17 mb-1 fw-semibold">{{ $customer->name }}</h4>
                                    <span class="fs-14">{{ $customer->store_name }}</span>
                                </div>
                            </div>
                    ...
                    <div class="card bg-white border-0 rounded-3 mb-4">
                        <div class="card-body p-4">
                            ...
                            <ul class="ps-0 mb-0 list-unstyled">
                                ...
                                <li class="d-flex align-items-center mb-2 pb-1">
                                    <span>Email:</span>
                                    <span class="text-secondary fw-medium ms-1">{{ $customer->email }}</span>
                                </li>
                                <li class="d-flex align-items-center mb-2 pb-1">
