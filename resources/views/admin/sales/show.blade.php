    ...
    <div class="col-lg-6">
        <div class="card bg-primary border-0 rounded-3 welcome-box style-two mb-4 position-relative">
            <div class="card-body py-38 px-4">
                <div class="mb-5">
                    <h3 class="text-white fw-semibold">Selamat Datang, <span class="text-danger-div">{{$user->name}}</span></h3>
                ...
                <div class="d-flex align-items-center flex-wrap gap-4 gap-xxl-5">
                    ...
                    <div class="d-flex align-items-center welcome-status-item style-two">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h5 class="text-white fw-semibold mb-0 fs-16">Rp.{{number_format($user->target_sales)}}</h5>
                    ...
                    <div class="d-flex align-items-center welcome-status-item style-two">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <h5 class="text-white fw-semibold mb-0 fs-16">{{number_format($user->target_sales)}} %</h5>
                            <p class="text-light">Pencapaian</p>
                        </div>
                    </div>
                </div>
            </div>
            <img src="{{asset('admin/assets')}}/images/welcome-2.gif" class="welcome-2 d-none d-sm-block" alt="welcome">
        </div>
    </div>
    <div class="col-lg-6">
        <div class="row justify-content-center">
