                            ...
                            <tr>
                                <th scope="col">
                                    <div class="form-check">
                                        <input class="form-check-input position-relative top-1" type="checkbox" value=""
    ...
    <script>
        ...
        $('#dataTable').on('click', '.folow-up', function (e) {
            ...
            function generateWhatsAppMessage(items, buyer, createAt) {
                let message = "Halo kak, kami dari PT MANDALIKA PUTRA BERSAMA mau mem-follow up pesanan Anda. Berikut detailnya:\n\n";
