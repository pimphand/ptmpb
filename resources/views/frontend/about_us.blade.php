    ...
    <div class="section-full p-t80 p-b50">
        <div class="container">
            ...
            <div class="section-head text-justify">
                ...
                <a href="{{asset('storage/'.$about->data['profile'])}}" target="_blank" class=" site-button m-r15" type="button">Download Profile Perusahaan</a>
            </div>
            <!-- TITLE END -->
            ...
            <div class="row mt-4">
                    ...
                    <div class="wt-icon-box-wraper left p-a30 bg-white">
                        <div class="wt-icon-box-md site-text-primary radius bdr-3">
                            <span class="icon-cell">
                                <img src="{{asset('certificate-svgrepo-com.svg')}}" width="60px" alt="{{env('APP_NAME')}}">
                            </span>
                        </div>
                ...
                <div class="col-lg-6 col-md-6 m-b30 animate bounce animated" data-animate="bounce" data-duration="1.0s" data-delay="0.1s" data-offset="100" style="animation-duration: 1s; animation-delay: 0.1s; visibility: visible;">
                    <div class="wt-icon-box-wraper left p-a30 bg-white">
                        <div class="wt-icon-box-md site-text-primary radius bdr-3">
                            <span class="icon-cell">
                                <img src="{{asset('law-auction-svgrepo-com.svg')}}" width="60px" alt="{{env('APP_NAME')}}">
                            </span>
                        </div>
                        <div class="icon-content">
                ...
                <div class="col-lg-6 col-md-6 m-b30 animate bounce animated" data-animate="bounce" data-duration="1.0s" data-delay="0.1s" data-offset="100" style="animation-duration: 1s; animation-delay: 0.1s; visibility: visible;">
                    <div class="wt-icon-box-wraper left p-a30 bg-white">
                        <div class="wt-icon-box-md site-text-primary radius bdr-3">
                            <span class="icon-cell">
                                <img src="{{asset('building-2-svgrepo-com.svg')}}" width="60px" alt="{{env('APP_NAME')}}">
                            </span>
                        </div>
                        <div class="icon-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 m-b30">
                    ...
                    <ul>
                        <li><h5>Menyediakan produk berkualitas
                                dengan harga yang kompetitif.</h5></li>
                        <li><h5>Memberikan pelayanan pelanggan
                                yang unggul melalui kerja sama yang
                                berkesinambungan.</h5></li>
                        <li><h5>Memperkuat kemitraan dengan
                                produsen oli ternama untuk menjaga
                                kualitas produk dan inovasi terkini.</h5></li>
                    </ul>
                </div>
            </div>
        </div>
